import{_ as i,c as a,a2 as n,o as l}from"./chunks/framework.DqceH366.js";const p="/assets/image-20240327194311322.DzhShJO9.png",h="/assets/image-20240327183117979.CcYFmlaz.png",e="/assets/image-20240327183634817.CsEMJEJY.png",t="/assets/image-20240327183916816.DTKmrq_F.png",k="/assets/image-20240327185736072.BAofqy9I.png",d="/assets/image-20240327194957533.BBC1WlXX.png",r="/assets/image-20240327190111409.Zzve5mZe.png",c="/assets/image-20240327192722530.Cm9bltTx.png",g="/assets/image-20240327192943689.i3AjAd_0.png",E="/assets/image-20240327193259203.CeXkB1Mh.png",o="/assets/image-20240327192330206.BHm53kgF.png",y="/assets/image-20240327194546837.6bvVPMi3.png",_=JSON.parse('{"title":"前后端分离项目部署","description":"","frontmatter":{},"headers":[],"relativePath":"linux/ProjectDeployment.md","filePath":"linux/ProjectDeployment.md","lastUpdated":1729167500000}'),F={name:"linux/ProjectDeployment.md"};function C(D,s,m,A,u,b){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="前后端分离项目部署" tabindex="-1">前后端分离项目部署 <a class="header-anchor" href="#前后端分离项目部署" aria-label="Permalink to &quot;前后端分离项目部署&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>本文采用阿里云服务器，centos7.9操作系统</span></span>
<span class="line"><span>本文默认服务器已安装nginx,mysql并且可以正常运行</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Django + vue + uwsgi + nginx</span></span></code></pre></div><p><strong>注意</strong>：先部署后端，使用<code>postman</code>测试请求没有问题后在修改<code>vue</code>中的<code>axios</code>文件中<code>baseURL</code>，顺序不要弄错</p><h2 id="前置消息" tabindex="-1">前置消息 <a class="header-anchor" href="#前置消息" aria-label="Permalink to &quot;前置消息&quot;">​</a></h2><h3 id="_1-服务器安全组端口设置" tabindex="-1">1 服务器安全组端口设置 <a class="header-anchor" href="#_1-服务器安全组端口设置" aria-label="Permalink to &quot;1 服务器安全组端口设置&quot;">​</a></h3><p><img src="`+p+'" alt="image-20240327194311322"></p><h3 id="_2-服务器域名解析" tabindex="-1">2 服务器域名解析 <a class="header-anchor" href="#_2-服务器域名解析" aria-label="Permalink to &quot;2 服务器域名解析&quot;">​</a></h3><p><img src="'+h+'" alt="image-20240327183117979"></p><h3 id="_3-ssl证书申请" tabindex="-1">3 ssl证书申请 <a class="header-anchor" href="#_3-ssl证书申请" aria-label="Permalink to &quot;3 ssl证书申请&quot;">​</a></h3><p><img src="'+e+'" alt="image-20240327183634817"></p><p><img src="'+t+`" alt="image-20240327183916816"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>申请后很快就能通过，下载nginx格式证书，备用</span></span>
<span class="line"><span></span></span>
<span class="line"><span>有几个需要用到的二级域名就需要几个ssl证书，用来支持HTTPS请求</span></span></code></pre></div><h2 id="后端项目部署" tabindex="-1">后端项目部署 <a class="header-anchor" href="#后端项目部署" aria-label="Permalink to &quot;后端项目部署&quot;">​</a></h2><p>项目规划：</p><ul><li>所有项目文件都放在<code>/od/</code>文件夹中</li><li>我的项目中，纯前端项目放在<code>/od/qianmo/</code>文件夹中，前后端分离项目中前端项目放在<code>od/front/</code>文件夹中， 后端项目放在<code>/od/backend/</code>文件夹中</li><li>所有<code>ssl</code>证书也都上传到<code>/od/</code>文件夹中，并且在此文件夹中解压，每个<code>ssl</code>证书都有一个单独的文件夹</li><li>关于<code>python</code>的虚拟环境放在<code>/od/backend/</code>文件夹中，与项目根目录同级；<code>uwsgi</code>的启动脚本放在<code>/od/backend/script/</code>文件夹中；日志文件放在<code>/od/backend/log/</code>文件夹中</li></ul><p><img src="`+k+'" alt="image-20240327185736072"></p><h3 id="_1-修改django配置文件" tabindex="-1">1 修改Django配置文件 <a class="header-anchor" href="#_1-修改django配置文件" aria-label="Permalink to &quot;1 修改Django配置文件&quot;">​</a></h3><p>将Django项目<code>settings.py</code>中<code>DEBUG</code>改为<code>True</code>,<code>ALLOWED_HOSTS</code>写成<code>[&quot;*&quot;]</code></p><p><img src="'+d+`" alt="image-20240327194957533"></p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 项目目录规划</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }   </span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h2 id="项目优化" tabindex="-1">项目优化 <a class="header-anchor" href="#项目优化" aria-label="Permalink to &quot;项目优化&quot;">​</a></h2><h3 id="_1-修改云服务器安全组的端口" tabindex="-1">1 修改云服务器安全组的端口 <a class="header-anchor" href="#_1-修改云服务器安全组的端口" aria-label="Permalink to &quot;1 修改云服务器安全组的端口&quot;">​</a></h3><p>在部署和测试完成后关闭云服务器mysql和redis的端口，增加云服务器的安全性</p><p><img src="`+y+'" alt="image-20240327194546837"></p>',62)]))}const v=i(F,[["render",C]]);export{_ as __pageData,v as default};
