...
export const SIDEBAR = {
    ...
    '/python/ObjectOriented/': {
        ...
        items: [
            ...
            {text: 'self对象，封装，继承，多态', link: '/python/ObjectOriented/self-encapsulation-inherit-polymorphism'},
        ],
    },
    '/python/supplement/': {
        text: 'python补充',
    ...
    '/linux': {
        text: 'linux',
        items: [
            {text: 'Linux命令(Ubuntu)', link: '/linux/commands'},
    ...
    '/machine_learning': {
        ...
        items: [
            {text: 'scikit-learn', link: '/machine_learning/scikit-learn'},
            {text: '分类算法', link: '/machine_learning/classification'},
            {text: '回归算法', link: '/machine_learning/regression'},
            {text: '聚类算法', link: '/machine_learning/clustering'},
            {text: '集成学习', link: '/machine_learning/ensemble_learning'},
        ]
    },
    '/deep_learning': {
        text: 'Deep learning',
